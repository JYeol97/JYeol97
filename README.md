...
- ⚙️ **인프라**: Docker, Jenkins 클라우드 환경 설계
- 🔗 **백엔드**: Django, FastAPI, Spring Boot 기반 API 개발
- 🗄️  **데이터베이스**: PostgreSQL, MySQL, SQLite 
...
- 🌍 **관광데이터 기반 AI 여행 블로그 생성 서비스** (2025.07 ~ 2025.11, 카카오와 함께하는 관광데이터 공모전) 
